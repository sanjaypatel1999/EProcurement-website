...
<html>
    ...
    <body bgcolor="gray">
        <div  id="outer">
            ...
            <div id="parent" style="margin-top: -20px;background-image:url('images/slider1.jpg');background-size:100% 100%;">
                <div id="main" style="width:950px;resize:none;margin-left:25px;">
                <h2 style="text-align:center;color:blue;font-size:40px;padding-top: 10px;">
                    All Complains
                </h2>
